...
const WHOP_LINK = "https://whop.com/cashmoves-io";
...
<span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                ...
                <span className="text-green-400 text-sm font-semibold">2 MEMBERS MAKING MOVES</span>
</div>
...
<StatCard number="90%" label="Hit Rate" />
<StatCard number="$240K" label="Member Profits" bordered />
